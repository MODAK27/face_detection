#python H:\jupyter_projects\face_detection\github_uploaded\video_facial_recognition.py -e H:\jupyter_projects\face_detection\github_uploaded\encodings\facial_encodings.pkl --distance-tolerance 0.5
...
while True:
    ...
    if output is None:
        ...
        output = cv2.VideoWriter("H:\\jupyter_projects\\face_detection\\github_uploaded\\videos\\output_video.mp4", fourcc, 24,
